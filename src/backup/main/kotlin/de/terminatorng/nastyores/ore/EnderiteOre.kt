...
object EnderiteOre: NastyOre("enderite") {
    ...
    override fun armorInfo(): ArmorInfo = ArmorInfo(17, intArrayOf(2, 5, 4, 1), 20)
    override fun toolInfo(): ToolInfo = ToolInfo(1, 120, 4.0F, 1.0F, 15)
