...
object KakkariteOre: INastyOreSettings {
    ...
    override fun drops(ore: Block, item: Item?): LootTable.Builder =
        LootTable.builder()
            .pool(LootPool.builder()
                .with(BlockLootTableGenerator.applyExplosionDecay(ore, ItemEntry.builder(item)
                    .apply(SetCountLootFunction.builder(ConstantLootNumberProvider.create(9000.0F)))
