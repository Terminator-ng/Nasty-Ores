...
object AmadeumOre: InventoryTickableNastyOre("amadeum") {
    ...
    override fun armorInfo(): ArmorInfo = ArmorInfo(10, intArrayOf(2, 6, 5, 2), 20)
    override fun toolInfo(): ToolInfo = ToolInfo(2, 250, 6.0F, 2.0F, 20)
